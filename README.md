...
| 1.3.3 | 相机画幅属性与格式识别增强：① 新增 `camera_formats`（支持画幅列表）和 `camera_default_format`（默认画幅）字段到 attribute_values 相机条目；② 新增 `6x9 中画幅` 和 `135 宽幅 / Xpan` 两种胶片格式预设值；③ 新增相机预设：Pentax MZ3 / MZ5 / MZ7（135+半格，默认 135）、Pentax 17（半格专用）、Pentax 645 / 645N / 645Nii、Contax 645、Mamiya 645 / 645 Super / 645 Pro、Bronica ETR / ETRSi / GS-1 / RF645、Fuji GW670 / GW690 II / GW690 III / GSW690 III / TX1 / TX2、Hasselblad Xpan / Xpan II、Mamiya Press、Rolleiflex 3.5F / Rolleicord Vb、海鸥 4A / 4B / 203、多款半格机（Olympus Pen 系列 / Canon Demi / Yashica Samurai / Ricoh Auto Half）、Holga 120N / Diana F+ 等；④ 导入时若相机只有单一画幅，直接写入无需像素分析；多画幅相机与 film_size_type 取交集后再调用 detectFilmFormat |
